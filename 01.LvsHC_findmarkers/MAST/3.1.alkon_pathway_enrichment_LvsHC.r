...
res_tcell <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/alkon_LvsHC_tcell_allmarkers.xlsx")
...
barplot_gsea(res_tcell_0.05$Reactome, 20, "Top 40 Tcell Alkon - Reactome")
...
# MAGIC %sh
# MAGIC mkdir /dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/GSEA_individually

# COMMAND ----------

#Save results
write.xlsx(res_tcell_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/GSEA_individually/res_tcell_0.05_alkon.xlsx")
write.xlsx(tcell_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/GSEA_individually/res_tcell_alkon_GO.xlsx")
...
res_macro <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/alkon_macro_LvsHC_allmarkers.xlsx")
...
barplot_gsea(res_macro_0.05$Reactome, 20, "Top 40 Macro Alkon - Reactome")
...
#Save results
write.xlsx(res_macro_0.05$Hallmark, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/GSEA_individually/res_macro_0.05_alkon_Hallmark.xlsx")
write.xlsx(macro_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/GSEA_individually/res_macro_alkon_GO.xlsx")
...
res_treg <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/alkon_treg_LvsHC_allmarkers.xlsx")
...
write.xlsx(treg_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/GSEA_individually/res_treg_alkon_GO.xlsx")
...
write.xlsx(fb_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/GSEA_individually/res_fb_alkon_GO.xlsx")
...
res_kc <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/alkon_kc_LvsHC_allmarkers.xlsx")
...
#Save results
write.xlsx(res_kc_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/GSEA_individually/res_kc_0.05_alkon.xlsx")
write.xlsx(kc_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/MAST_method/GSEA_individually/res_kc_alkon_GO.xlsx")
...
res_kc_seurat <- lapply(getSheetNames("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/GSEA_individually/res_kc_0.05_alkon.xlsx"), function(sheet) {
  read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/GSEA_individually/res_kc_0.05_alkon.xlsx", sheet = sheet)
})
names(res_kc_seurat) <- getSheetNames("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/GSEA_individually/res_kc_0.05_alkon.xlsx")
...
barplot_gsea(res_kc_seurat$Reactome, 15, "Top 30 KC Alkon SEURAT - Reactome")
