...
res_tcell <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA//Liu/LvsHC/pseudobulk/liu_tcell_LvsHC_bulk.xlsx")
...
write.xlsx(tcell_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/pseudobulk/res_tcell_liu_GO.xlsx")
...
res_macro <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/pseudobulk/liu_macro_LvsHC_bulk.xlsx")
...
write.xlsx(macro_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/pseudobulk/res_macro_liu_GO.xlsx")
...
res_treg <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/pseudobulk/liu_treg_LvsHC_bulk.xlsx")
...
res_ilc <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/pseudobulk/liu_ilc_LvsHC_bulk.xlsx")
...
#Save results
write.xlsx(ilc_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/pseudobulk/res_ilc_liu_GO.xlsx")
...
res_mastc <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/pseudobulk/liu_mast_LvsHC_bulk.xlsx")
...
#Save results
write.xlsx(mast_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/pseudobulk/res_mast_liu_GO.xlsx")
...
res_mono <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/pseudobulk/liu_mono_LvsHC_bulk.xlsx")
...
res_dc <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/pseudobulk/liu_dc_LvsHC_bulk.xlsx")
...
dotplot_pathway_generator(res_dc_0.05$KEGG, 20, "Top DC Liu - kegg")
...
#Save results
write.xlsx(res_dc_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/pseudobulk/res_dc_0.05_liu.xlsx")
write.xlsx(dc_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/pseudobulk/res_dc_liu_GO.xlsx")
...
res_nk <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/pseudobulk/liu_nk_LvsHC_bulk.xlsx")
...
nk_GO <- enrichGO(gene = names(geneList_entrez_nk),
                OrgDb         = org.Hs.eg.db,
                keyType       = "ENTREZID",
                ont           = "BP", 
                pAdjustMethod = "BH",
...
# Extract results
res_nk_GO <- nk_GO@result

# Filter results to include only those with p.adjust < 0.05
filtered_res_nk_GO <- res_nk_GO %>%
  filter(p.adjust < 0.05)

# Display filtered results
display(filtered_res_nk_GO)
...
#Save results
write.xlsx(nk_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/pseudobulk/res_nk_liu_GO.xlsx")
