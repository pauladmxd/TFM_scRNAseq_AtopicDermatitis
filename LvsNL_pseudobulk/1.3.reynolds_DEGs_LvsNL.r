...
pseudo_reynolds <- AggregateExpression(reynolds, assays = "RNA", return.seurat = T, group.by = c("Condition", "donor_id", "h_celltype"))
...
tcell.de <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsNL/reynolds_LvsNL_tcell_markers.xlsx")
...
table(pseudo_reynolds$donor_id, pseudo_reynolds$Condition)

# COMMAND ----------

bulk.kc.de <- FindMarkers(object = pseudo_reynolds, 
                         ident.1 = "KC_lesional", 
                         ident.2 = "KC_non-lesional",
                         test.use = "DESeq2")
...
kc.de <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsNL/reynolds_kc_LvsNL_markers.xlsx")
...
kc.de.orig <- kc.de.orig %>%
    mutate(avg_log2FC = ifelse(cluster == "non lesional", -abs(avg_log2FC), avg_log2FC)) #It is done because the analysis was done only with positive results and to be able to differentiate healthy and lesional I assign that sign
...
write.xlsx(bulk.fb.de.orig, file="/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/pseudobulk/reynolds_fb_LvsHC_bulk.xlsx")
write.xlsx(bulk.treg.de.orig, file="/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/pseudobulk/reynolds_treg_LvsHC_bulk.xlsx")
write.xlsx(bulk.kc.de.orig, file="/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/pseudobulk/reynolds_kc_LvsHC_bulk.xlsx")
write.xlsx(bulk.tcell.de.orig, file="/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/pseudobulk/reynolds_tcell_LvsHC_bulk.xlsx")
write.xlsx(bulk.macro.de.orig, file="/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/pseudobulk/reynolds_macro_LvsHC_bulk.xlsx")
write.xlsx(bulk.mono.de.orig, file="/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/pseudobulk/reynolds_mono_LvsHC_bulk.xlsx")
write.xlsx(bulk.dc.de.orig, file="/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/pseudobulk/reynolds_dc_LvsHC_bulk.xlsx")
write.xlsx(bulk.ilc.de.orig, file="/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/pseudobulk/reynolds_ilc_LvsHC_bulk.xlsx")
write.xlsx(bulk.nk.de.orig, file="/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/pseudobulk/reynolds_nk_LvsHC_bulk.xlsx")
write.xlsx(bulk.mastc.de.orig, file="/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/pseudobulk/reynolds_mast_LvsHC_bulk.xlsx")
