...
# MAGIC %md
# MAGIC # Pathway enrichment in LvsHC Liu markers
...
res_tcell <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/liu_LvsHC_tcell_allmarkers.xlsx")
...
barplot_gsea(res_tcell_0.05$Hallmark1, 20, "Top 40 Tcell Liu - Hallmark H")

# COMMAND ----------

dotplot_pathway_generator(res_tcell_0.05$KEGG, 20, "Top Tcell Liu - KEGG")

# COMMAND ----------

barplot_gsea(res_tcell_0.05$Reactome, 30, "Top Tcell Liu - Reactome")
...
barplot(tcell_GO, showCategory=30, label_format=50, font.size=9) + ggtitle("Liu - Tcell - L vs HC - GO")

# COMMAND ----------

#Save results
write.xlsx(res_tcell_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_tcell_0.05_liu.xlsx")
write.xlsx(tcell_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_tcell_liu_GO.xlsx")

# COMMAND ----------

res_tcell_0.05 <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_tcell_0.05_liu.xlsx", sheet = 2)
...
res_tcell_0.05[grep("IL13", res_tcell_0.05$Description), ]
...
res_macro <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/liu_macro_LvsHC_allmarkers.xlsx")
...
barplot_gsea(res_macro_0.05$Hallmark1, 20, "Top 40 Macro Liu - Hallmark")

# COMMAND ----------

options(repr.plot.width=1500, repr.plot.height=1000,  echo= F)
barplot_gsea(res_macro_0.05$Hallmark2, 20, "Top 40 Macro Liu - Hallmark C2")

# COMMAND ----------

options(repr.plot.width=1500, repr.plot.height=1000,  echo= F)
barplot_gsea(res_macro_0.05$Reactome, 20, "Top 40 Macro Liu - Reactome")

# COMMAND ----------

options(repr.plot.width=1500, repr.plot.height=1000,  echo= F)
barplot_gsea(res_macro_0.05$KEGG, 20, "Top 40 Macro Liu - KEGG")

# COMMAND ----------

options(repr.plot.width=1500, repr.plot.height=1000,  echo= F)
dotplot_pathway_generator(res_macro_0.05$Hallmark2, 20,  "Top Macro Liu - Hallmarks C2")
...
options(repr.plot.width=1000, repr.plot.height=1000,  echo= F)
barplot(macro_GO, showCategory=30, label_format=50, font.size=9) + ggtitle("Liu- Macro - L vs HC - GO")
...
#Save results
write.xlsx(res_macro_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_macro_0.05_liu.xlsx")
write.xlsx(macro_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_macro_liu_GO.xlsx")
...
res_treg <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/liu_treg_LvsHC_allmarkers.xlsx")
...
barplot_gsea(res_treg_0.05$Hallmark2, 30, "Top Treg Liu - Hallmark C2")

# COMMAND ----------

options(repr.plot.width=1500, repr.plot.height=1000,  echo= F)
barplot_gsea(res_treg_0.05$Reactome, 30, "Top Treg Liu - Reactome")

# COMMAND ----------

  options(repr.plot.width = 1300, repr.plot.height = 1000, echo = FALSE)
dotplot_pathway_generator(res_treg_0.05$Reactome, 20, "Top Treg Liu - Reactome")
...
options(repr.plot.width=1000, repr.plot.height=1000,  echo= F)
barplot(treg_GO, showCategory=30, label_format=50, font.size=9) + ggtitle("Liu- Treg - L vs HC - GO")
...
write.xlsx(res_treg_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_treg_0.05_liu.xlsx")
write.xlsx(treg_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_treg_liu_GO.xlsx")
...
res_ilc <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/liu_ILC_LvsHC_allmarkers.xlsx")
...
#Save results
write.xlsx(ilc_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_ilc_liu_GO.xlsx")
...
res_mastc <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/liu_mast_LvsHC_allmarkers.xlsx")
...
#Save results
write.xlsx(mast_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_mast_liu_GO.xlsx")
...
res_mono <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/liu_mono_LvsHC_allmarkers.xlsx")
...
barplot_gsea(res_mono_0.05$Hallmark1, 20, "Top 40 Mono Liu - Hallmark")

# COMMAND ----------

  options(repr.plot.width = 1400, repr.plot.height = 1000, echo = FALSE)
dotplot_pathway_generator(res_mono_0.05$Hallmark2, 20, "Top 40 Mono Liu - Hallmark c2")
...
#Save results
write.xlsx(res_mono_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_mono_0.05_liu.xlsx")
write.xlsx(mono_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_mono_liu_GO.xlsx")
...
res_dc <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/liu_dc_LvsHC_allmarkers.xlsx")
...
options(repr.plot.width = 1400, repr.plot.height = 1000, echo = FALSE)
dotplot_pathway_generator(res_dc_0.05$Hallmark2, 20, "Top 40 DC Liu - Hallmark c2")

# COMMAND ----------

options(repr.plot.width = 1200, repr.plot.height = 1000, echo = FALSE)
dotplot_pathway_generator(res_dc_0.05$Reactome, 30, "Top 60 DC Liu - Reactome")
...
#Save results
write.xlsx(res_dc_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_dc_0.05_liu.xlsx")
write.xlsx(dc_GO, "/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/GSEA_individually/res_dc_liu_GO.xlsx")
...
res_nk <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Liu/LvsHC/liu_nk_LvsHC_allmarkers.xlsx")

# COMMAND ----------

geneList_entrez_nk <- prepare_gene_list(res_nk, G_list)

# COMMAND ----------

res_nk_0.05 <- get_enrichments(geneList_entrez_nk, 0.05, H_t2g, C2_t2g)

# COMMAND ----------

res_nk_0.1 <- get_enrichments(geneList_entrez_nk, 0.1, H_t2g, C2_t2g)
