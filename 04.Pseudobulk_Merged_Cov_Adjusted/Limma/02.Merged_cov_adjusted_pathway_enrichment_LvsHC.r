...
# MAGIC %sh
# MAGIC  mkdir /dbfs/mnt/sandbox/TFM_PAULA/merged_AR_results/GSEA/Limma

# COMMAND ----------

#Save results
write.xlsx(res_kc_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/merged_AR_results/GSEA/Limma/res_kc_0.05_AR.xlsx")
...
#Save results
write.xlsx(res_tcell_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/merged_AR_results/GSEA/Limma/res_tcell_0.05_AR_.xlsx")
...
#Save results
write.xlsx(res_macro_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/merged_AR_results/GSEA/Limma/res_macro_0.05_AR.xlsx")
...
write.xlsx(res_treg_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/merged_AR_results/GSEA/Limma/res_treg_0.05_AR.xlsx")
...
#Save results
write.xlsx(res_fb_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/merged_AR_results/GSEA/Limma/res_fb_0.05_AR.xlsx")
