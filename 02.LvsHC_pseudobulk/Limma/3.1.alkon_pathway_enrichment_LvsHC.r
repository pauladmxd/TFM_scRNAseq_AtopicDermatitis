...
res_tcell <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/pseudobulk/alkon_limma_results_tcell.xlsx")
...
barplot_gsea(res_tcell_0.05$Reactome, 20, "Top Tcell Alkon - Reactome")
...
#Save results
write.xlsx(res_tcell_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/GSEA_individually/pseudobulk/res_tcell_0.05_alkon_limma.xlsx")
...
res_fb <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/pseudobulk/alkon_limma_results_FB.xlsx")
...
barplot_gsea(res_fb_0.05$Reactome, 20, "Top FB Alkon - Reactome")
...
#Save results
write.xlsx(res_fb_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/GSEA_individually/res_fb_0.05_alkon_limma.xlsx")
...
res_kc <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/pseudobulk/alkon_limma_results_kc.xlsx")
...
barplot_gsea(res_kc_0.05$Reactome, 20, "Top KC Alkon - Reactome")

# COMMAND ----------

display(res_kc_0.05$Reactome)

# COMMAND ----------

display(res_tcell_0.05$Reactome)
...
#Save results
write.xlsx(res_kc_0.05, "/dbfs/mnt/sandbox/TFM_PAULA/Alkon/GSEA_individually/pseudobulk/res_kc_0.05_alkon_limma.xlsx")
...
res_tcell_0.05$Reactome[grepl("R-HSA-6785807", res_tcell_0.05$Reactome$ID), ]
