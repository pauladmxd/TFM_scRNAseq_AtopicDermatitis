...
reynolds_kc_react <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/GSEA_individually/res_kc_0.05_reynolds_limma.xlsx", sheet =2)
alkon_kc_react <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/GSEA_individually/pseudobulk/res_kc_0.05_alkon_limma.xlsx", sheet=2)
...
reynolds_tcell_react <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/GSEA_individually/res_tcell_0.05_reynolds_limma.xlsx", sheet =2)
alkon_tcell_react <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/GSEA_individually/pseudobulk/res_tcell_0.05_alkon_limma.xlsx", sheet=2)
...
reynolds_fb_react <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Reynolds/LvsHC/GSEA_individually/res_fb_0.05_reynolds_limma.xlsx", sheet =2)
alkon_fb_react <- read.xlsx("/dbfs/mnt/sandbox/TFM_PAULA/Alkon/GSEA_individually/res_fb_0.05_alkon_limma.xlsx", sheet=2)
...
# MAGIC %md
# MAGIC 6% of the terms are common with same sign
...
# MAGIC %md
# MAGIC 36.6% are common terms with contrary NES sign
